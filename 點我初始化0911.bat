...
set "ZIP_URL=https://github.com/SugarSquirrel/tickets_hunter/archive/refs/heads/0911-kham.zip"
set "ZIP_NAME=tickets_hunter_0911-kham.zip"
set "EXTRACT_DIR=%USERPROFILE%\0911-kham"
set "TARGET_SUBDIR=tickets_hunter-0911-kham"
...
echo [3/5] Downloading the tickets_hunter 0911-kham branch...
